            ...
            <div>
                ...
                <div class="result-container">
                    ...
                    <?php
                        ...
                        if($cat==104)
                        {
                            $sql="SELECT P.pname AS PName, P.product_ID AS PID FROM Product P WHERE P.pname LIKE '%$product%' AND (P.price>=$min AND P.price<=$max);";
                        }
                        else//with category
                        {
                            $sql="SELECT P.pname AS PName, P.product_ID AS PID  FROM Product P, belongs_to b WHERE P.pname LIKE '%$product%' AND (b.product_ID=P.product_ID) AND (b.category_ID=$cat) AND (P.price>=$min AND P.price<=$max) ;";
                        }
