    ...
    <div id="container">
        <div id="content-wrap">
            ...
            <div clas="secondrow">
                ...
                <div class="catinput">
                    <div>
                        <H1 class="smallheading2">CHOOSE SELLER ID AND PRODUCT ID</H1>
                    </div>
                    <div>
                        <form action="putsuphelper.php" method="POST" class="l_form">
                            <div class="containerform">
                                <label for="sID"><b>SellerID</b></label>
                                <select name = "sID" required>
                                <?php
                                $data = $conn->query("SELECT * FROM seller");
                              ...
                              <label for="pID"><b>ProductID</b></label>
